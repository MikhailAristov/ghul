...
AppId={{3E162784-D9B8-4623-834E-A3701C6DD98C}
AppName={#MyAppName}
...
InfoAfterFile=.\dev_message.rtf
OutputDir=..\Build\install
OutputBaseFilename=setup_ghul_{#MyAppVersion}_expo
SetupIconFile=.\ghul_icon.ico
Compression=lzma
...
[Files]
Source: "..\Build\game\Ghul_EXPO.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\Build\game\Ghul_EXPO_Data\*"; DestDir: "{app}\Ghul_EXPO_Data"; Flags: ignoreversion recursesubdirs createallsubdirs
